...
# -*- coding: utf-8 -*-
#
# upsetjs_jupyter_widget documentation build configuration file
#
...
htmlhelp_basename = 'upsetjs_jupyter_widgetdoc'
...
latex_documents = [
    (master_doc, 'upsetjs_jupyter_widget.tex', 'upsetjs_jupyter_widget Documentation',
     'Samuel Gratzl', 'manual'),
]
...
man_pages = [
    ...
    'upsetjs_jupyter_widget Documentation',
     [author], 1)
]
